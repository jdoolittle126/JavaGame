...
public class TestActor extends Actor {
	...
	public void draw(Batch batch, float parentAlpha) {
		...
		*/
		...
		Vector3 test2 = editWindow.getTestStage().getCamera().unproject(new Vector3(MapEditWindow.mouse_coords_window.x, MapEditWindow.mouse_coords_window.y, 0));
		Vector3 test = MapEditor.getEditor().getStage().getCamera().unproject(test2);
		
		
		System.out.println("MOUSE: " + test.x + ", " + test.y + "\t" + MapEditWindow.mouse_coords_window.x + ", " + MapEditWindow.mouse_coords_window.y);
		if(editWindow.isWithinWindow(new Point2(MapEditWindow.mouse_coords_window.x, MapEditWindow.mouse_coords_window.y))) {
