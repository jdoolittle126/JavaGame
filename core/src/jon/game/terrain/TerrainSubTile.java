...
public class TerrainSubTile extends Actor {
	...
	public TerrainSubTile(Point2 coords, TileType type) {
		...
		if(type == TileType.grass) material = new Material(Materials.grass);
		else if(type == TileType.water) material = new Material(Materials.water);
		else material = new Material(Materials.grass);
